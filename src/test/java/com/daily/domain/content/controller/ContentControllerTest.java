...
import com.daily.fixtures.ContentFixtures;
...
import static com.daily.fixtures.ContentFixtures.NAVER_CONTENT_RESPONSE;
...
class ContentControllerTest extends ControllerTest {
    ...
    void 사이트의_컨텐츠_정보를_조회한다() throws Exception {
        // given
        given(any()).willReturn(NAVER_CONTENT_RESPONSE());
        ...
        mockMvc.perform(get("/content/site")
                ...
                .andDo(document("content site",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("link").type(JsonFieldType.ARRAY).description("컨텐츠 링크"),
